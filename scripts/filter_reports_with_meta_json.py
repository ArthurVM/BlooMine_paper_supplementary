        ...
        for seq, subtype, count in minor_alleles:
            ...
            if stutter_filter:
                ...
                if is_stutter_3 or is_stutter_6:
                    ## calc af relative to the major allele for stutter check
...
def main(poly_json):
    ...
    for l in range(1, 31, 1):
        ...
        for c in range(1, 31):
            ## cov 1-30
            run(poly_json, af, c, outdir="../data/stutter_filter_c_vs_af/", l3=l3, l6=l6)

if __name__=="__main__":
    ## feed me a JSON generated by parsing BM reports
    main(sys.argv[1])